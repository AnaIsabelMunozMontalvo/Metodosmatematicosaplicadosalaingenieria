...
function [soluciont,soluciony]=eulerimplicito(f,intiempo,valorini,npasos)
% este código resuelve un problema de valor inicial y'=f(t,y), y(t0)=y0
%utlizando el método de euler implícito
...
soluciony(1)=valorini; % always create a vector column
